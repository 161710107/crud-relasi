	...
	<div class="container">
		<div class="col-md-12">
			<div class="panel panel-primary">
			  <div class="panel-heading">Edit Data santri 
			  	<div class="panel-title pull-right"><a href="{{ url()->previous() }}">Kembali</a>
			  	</div>
			  </div>
			  <div class="panel-body">
			  	<form action="{{ route('santri.update',$mhs->id) }}" method="post" >
        			...
        			{{ csrf_field() }}
			  		...
			  		<div class="form-group {{ $errors->has('nis') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" value="{{ $mhs->nis }}" name="nis" class="form-control"  required>
			  			@if ($errors->has('nis'))
                            <span class="help-block">
